...
MySQL - 10.4.32-MariaDB : Database - db_toko_json
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_toko_json` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `transaksi` (
  ...
  `data_barang` longtext DEFAULT NULL,
  `data_pelanggan` longtext DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),

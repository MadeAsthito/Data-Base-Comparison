...
def measure_query_execution(query:str, iterations:int):
    conn.commit()
...
if __name__ == '__main__':
    ...
    measure_query_execution(query, iterations)
    print()

    measure_select_generated_data()
    print()

    measure_insert_generated_data(iterations)
